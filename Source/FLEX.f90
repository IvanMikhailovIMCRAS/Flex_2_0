...
!!!!!!!!!!!!!!!!!!!! ENGINE OF PROGRAM  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    do while (deviation.gt.tolerance)
        ...
        &     dabs(U1(1:n_layer)-W1(1:n_layer)) + dabs(U2(1:n_layer)-W2(1:n_layer)) + &
        &     dabs(Us(1:n_layer)-Ws(1:n_layer)))
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    & - sum(alpha(1:n_layer)*phi_pol1(1:n_layer)) &
    & - sum(alpha(1:n_layer)*phi_pol2(1:n_layer)) &
    & - sum(U1(1:n_layer)*phi_pol1(1:n_layer)) &
    & - sum(U2(1:n_layer)*phi_pol2(1:n_layer)) &
    & + sum(phi_solv(1:n_layer)*log(phi_solv(1:n_layer))) &
